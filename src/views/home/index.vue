...
const list = [
  {
    ...
    content: '渐进式JavaScript 框架易学易用，性能出色，适用场景丰富的 Web 前端框架。',
  ...
  },
  {
    ...
    content: '网站快速成型工具， Element-plus一套为开发者、设计师和产品经理准备的桌面端组件库',
    href: 'https://element-plus.org/zh-CN/'
  },
  {
    img: 'https://dragon-xjy.atomgit.net/xjy-admin/assets/ts-B5SDG0Zo.png',
    color: 'rgb(0, 122, 204)',
    content: 'TypeScript具有类型系统，且是JavaScript的超集。 它可以编译成普通的JavaScript代码。',
