<template>
  <div>
    ...
    <el-card style="margin:10px 0" shadow="never">
      <div v-if="sence">
        <el-button :disabled="categoryStore.c3Id ? false : true" icon="Plus" type="primary"
        ...
        <el-table :data="attrArr" border style="margin:10px 0">
          ...
          <el-table-column label="操作">
            <template #="{ row }">
              <el-button type="primary" plain size="small" icon="Edit" @click="updateAttr(row)"></el-button>
              <el-popconfirm @confirm="deleteAttr(row.id)" :title="`确认删除${row.attrName}吗？`">
                <template #reference>
                  <el-button type="warning" plain size="small" icon="Delete"></el-button>
                </template>
              </el-popconfirm>
            </template>
          </el-table-column>
      ...
      <div v-else>
        ...
        <el-button :disabled="attrParams.attrName?false:true" size="small" type="primary" icon="Plus"
        ...
        <el-table :data="attrParams.attrValueList" border style="margin:10px 0">
          ...
          <el-table-column label="属性值操作">
            <template #="{$index}">
              <el-button @click="attrParams.attrValueList.splice($index,1)" type="warning" size="small"
                icon="Delete"></el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-button :disabled="attrParams.attrValueList.length>0?false:true" size="small" type="primary"
